...
\renewcommand{\flhead}{\vskip5pt \fboxsep=0pt {\small\bfseries\footnotesize \Sexpr{df$full_cat[i]} | \Sexpr{df$full_cat_en[i]}}}
\renewcommand{\fcfoot}{\vskip5pt \fboxsep=0pt \hspace{2pt}{\small\bfseries\footnotesize \Sexpr{df$tier[i]}}}

\renewcommand{\blhead}{\vskip5pt {\small\bfseries\footnotesize \Sexpr{df$full_cat[i]} | \Sexpr{df$full_cat_en[i]} }}
