...
# Ukranian
my_deck = genanki.Deck(deck_id=gen_id(), name="IceFlash4k_ukr_v2")
...
## load templates
# Ukranian
tmp_dir = glob.glob("templates/Anki/ukr/*.yml")

## load data and generate cards
# Ukranian
tsvfile = "data/list_4k_ukr.tsv"
...
main_pkg.write_to_file(os.path.join(output_dir, "IceFlash4k_ukr_v2.apkg"))
os.chdir(project_dir)
