...
# Chinese
my_deck = genanki.Deck(deck_id=gen_id(), name="IceFlash4k_zh_v2")
...
## load templates
# Chinese
tmp_dir = glob.glob("templates/Anki/zh/*.yml")

## load data and generate cards
# Chinese
tsvfile = "data/list_4k_zh.tsv"
...
main_pkg.write_to_file(os.path.join(output_dir, "IceFlash4k_zh_v2.apkg"))
os.chdir(project_dir)
